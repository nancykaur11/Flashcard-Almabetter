    ...
    <section className="flex flex-col text-slate-600">
      <header className="flex">
        ...
        <div className="flex flex-col">
          <h2 className="text-xl text-black font-bold">{activeGroup?.groups?.group}</h2>
      ...
      <main className="mt-6 grid grid-rows-1 md:grid-cols-4">
        <aside className="col-span-1 bg-white w-[60vw] md:w-[10rem] xl:w-[17rem] m-5 px-1 py-2 h-fit rounded-md">
          ...
          {activeGroup.terms && activeGroup?.terms.map((d)=>{ 
          <img
          alt="cardimage"
          src={d.image} 
        ...
        />
          ...
          <p className={`py-2 px-8 text-slate-700 font-medium hover:bg-slate-100 cursor-pointer`}>
